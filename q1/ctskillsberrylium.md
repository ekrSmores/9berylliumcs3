...
Main Problem: 
Canteen is extremely slow due to the poor effeciency of the current features they have.
...
1.Slow Ordering
2.Manual Cashier
3.Lacks Inventory Tracking
4.Crowded lines

Step 3: Define Computational Thinking Approaches
For each sub-problem, apply CT skills:
1.Slow Ordering | Abstraction | Make a simple menu with prices after it.
